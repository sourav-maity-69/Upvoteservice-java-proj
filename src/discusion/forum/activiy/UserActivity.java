...
public class UserActivity {
	...
	public void deleteQuestion(UserActivity userActivity, User user) throws NumberFormatException, IOException {
		...
		/*
		 * else if(user.getUserRole()==UserRole.MODERATOR) { if
		 * (user.getUser().getUserRole() == UserRole.USER) {
		 * replyService.deleteReply(reply); } else if (reply.getUser() == user) {
		 * replyService.deleteReply(reply); } else {
		 * System.out.println("You are not authorised to delete this reply"); } } else
